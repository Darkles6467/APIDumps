...
enum class DeviceType
{
	NullDevice = 0x0,
	SpecificDevice = 0x1,
	DefaultSystemDevice = 0x2,
	DefaultCommunicationDevice = 0x3,
};
...
enum class EFileWrite
{
	...
	FILEWRITE_DeleteOnCloseIfZeroSizedFile = 0x20,
};
...
enum class VkExternalSemaphoreFeatureFlagBits
{
...
enum class VkPointClippingBehavior
{
...
enum class VkViewportCoordinateSwizzleNV
{
...
namespace mscorlib
{
	...
	{
		CallingConventions_Standard = 0x1,
		CallingConventions_VarArgs = 0x2,
		CallingConventions_Any = 0x3,
		CallingConventions_HasThis = 0x20,
		CallingConventions_ExplicitThis = 0x40,
	};
}
...
enum class ECompilerFlags
{
	...
	CFLAG_OnChip = 0x5,
	CFLAG_KeepDebugInfo = 0x6,
	CFLAG_NoFastMath = 0x7,
	CFLAG_ZeroInitialise = 0x8,
	CFLAG_BoundsChecking = 0x9,
	CFLAG_FeatureLevelES31 = 0xa,
	CFLAG_ForceRemoveUnusedInterpolators = 0xb,
	CFLAG_UseFullPrecisionInPS = 0xc,
	CFLAG_VertexToGeometryShader = 0xd,
	CFLAG_Archive = 0xe,
	CFLAG_UsesExternalTexture = 0xf,
	CFLAG_UseEmulatedUB = 0x10,
};
...
enum class VkTessellationDomainOrigin
{
...
enum class VkPeerMemoryFeatureFlagBits
{
...
enum class VkResult
{
	...
	VK_EVENT_RESET = 0x4,
	VK_INCOMPLETE = 0x5,
	VK_ERROR_OUT_OF_HOST_MEMORY = 0xff,
	VK_ERROR_OUT_OF_DEVICE_MEMORY = 0xfe,
	VK_ERROR_INITIALIZATION_FAILED = 0xfd,
	VK_ERROR_DEVICE_LOST = 0xfc,
	VK_ERROR_MEMORY_MAP_FAILED = 0xfb,
	VK_ERROR_LAYER_NOT_PRESENT = 0xfa,
	VK_ERROR_EXTENSION_NOT_PRESENT = 0xf9,
	VK_ERROR_FEATURE_NOT_PRESENT = 0xf8,
	VK_ERROR_INCOMPATIBLE_DRIVER = 0xf7,
	VK_ERROR_TOO_MANY_OBJECTS = 0xf6,
	VK_ERROR_FORMAT_NOT_SUPPORTED = 0xf5,
	VK_ERROR_FRAGMENTED_POOL = 0xf4,
...
namespace mscorlib
{
	...
	{
		MethodAttributes_MemberAccessMask = 0x7,
		MethodAttributes_PrivateScope = 0x0,
		MethodAttributes_Private = 0x1,
		MethodAttributes_FamANDAssem = 0x2,
		MethodAttributes_Assembly = 0x3,
		MethodAttributes_Family = 0x4,
		MethodAttributes_FamORAssem = 0x5,
		MethodAttributes_Public = 0x6,
		MethodAttributes_Static = 0x10,
		MethodAttributes_Final = 0x20,
		MethodAttributes_Virtual = 0x40,
		MethodAttributes_HideBySig = 0x80,
		MethodAttributes_CheckAccessOnOverride = 0x200,
		MethodAttributes_VtableLayoutMask = 0x100,
		MethodAttributes_ReuseSlot = 0x0,
		MethodAttributes_NewSlot = 0x100,
		MethodAttributes_Abstract = 0x400,
		MethodAttributes_SpecialName = 0x800,
		MethodAttributes_PinvokeImpl = 0x2000,
		MethodAttributes_UnmanagedExport = 0x8,
		MethodAttributes_RTSpecialName = 0x1000,
		MethodAttributes_ReservedMask = 0xd000,
...
enum class VkSamplerYcbcrModelConversion
{
...
enum class EDepthStencilTargetActions
{
	DepthMask = 0x4,
...
enum class VkSystemAllocationScope
{
...
enum class VkCommandBufferUsageFlagBits
{
...
enum class VkFormatFeatureFlagBits
{
...
namespace mscorlib
{
	enum MemberTypes
	{
		MemberTypes_Constructor = 0x1,
		MemberTypes_Event = 0x2,
		MemberTypes_Field = 0x4,
		MemberTypes_Method = 0x8,
		MemberTypes_Property = 0x10,
		MemberTypes_TypeInfo = 0x20,
		MemberTypes_Custom = 0x40,
		MemberTypes_NestedType = 0x80,
		MemberTypes_All = 0xbf,
	};
}
...
enum class TTSDestination
{
	...
	LocalPlayback = 0x1,
	RemoteTransmissionWithLocalPlayback = 0x2,
	QueuedRemoteTransmission = 0x3,
	QueuedLocalPlayback = 0x4,
	QueuedRemoteTransmissionWithLocalPlayback = 0x5,
	ScreenReader = 0x6,
};
...
namespace mscorlib
{
	enum TypeAttributes
	{
		TypeAttributes_VisibilityMask = 0x7,
		TypeAttributes_NotPublic = 0x0,
		TypeAttributes_Public = 0x1,
		TypeAttributes_NestedPublic = 0x2,
		TypeAttributes_NestedPrivate = 0x3,
		TypeAttributes_NestedFamily = 0x4,
		TypeAttributes_NestedAssembly = 0x5,
		TypeAttributes_NestedFamANDAssem = 0x6,
	};
}
...
namespace mscorlib
{
	...
	{
		StreamingContextStates_CrossProcess = 0x1,
		StreamingContextStates_CrossMachine = 0x2,
		StreamingContextStates_File = 0x4,
		StreamingContextStates_Persistence = 0x8,
		StreamingContextStates_Remoting = 0x10,
		StreamingContextStates_Other = 0x20,
		StreamingContextStates_Clone = 0x40,
		StreamingContextStates_CrossAppDomain = 0x80,
		StreamingContextStates_All = 0xff,
	};
}
...
enum class ERenderTargetActions
{
	LoadOpMask = 0x2,
	DontLoad_DontStore = 0x0,
	DontLoad_Store = 0x1,
...
enum class VkSamplerReductionModeEXT
{
...
enum class VkStencilFaceFlagBits
{
...
namespace mscorlib
{
	enum PropertyAttributes
	{
		...
		PropertyAttributes_SpecialName = 0x200,
		PropertyAttributes_ReservedMask = 0xf400,
		PropertyAttributes_RTSpecialName = 0x400,
		PropertyAttributes_HasDefault = 0x1000,
		PropertyAttributes_Reserved2 = 0x2000,
		PropertyAttributes_Reserved3 = 0x4000,
		PropertyAttributes_Reserved4 = 0x8000,
	};
}
...
namespace mscorlib
{
	enum BindingFlags
	{
		BindingFlags_Default = 0x0,
		BindingFlags_IgnoreCase = 0x1,
		BindingFlags_DeclaredOnly = 0x2,
		BindingFlags_Instance = 0x4,
		BindingFlags_Static = 0x8,
		BindingFlags_Public = 0x10,
		BindingFlags_NonPublic = 0x20,
		BindingFlags_FlattenHierarchy = 0x40,
		BindingFlags_InvokeMethod = 0x100,
		BindingFlags_CreateInstance = 0x200,
		BindingFlags_GetField = 0x400,
		BindingFlags_SetField = 0x800,
		BindingFlags_GetProperty = 0x1000,
		BindingFlags_SetProperty = 0x2000,
		BindingFlags_PutDispProperty = 0x4000,
		BindingFlags_PutRefDispProperty = 0x8000,
...
namespace mscorlib
{
	...
	{
		MethodImplAttributes_CodeTypeMask = 0x3,
		MethodImplAttributes_IL = 0x0,
		MethodImplAttributes_Native = 0x1,
		MethodImplAttributes_OPTIL = 0x2,
	};
}
...
{
	InverseByDistance = 0x0,
	LinearByDistance = 0x1,
	ExponentialByDistance = 0x2,
};
...
enum class VkDeviceEventTypeEXT
{
...
enum class VkQueryResultFlagBits
{
...
enum class VkDisplayPowerStateEXT
{
...
enum class VkConservativeRasterizationModeEXT
{
...
enum class VkPipelineBindPoint
{
...
enum class VkCoverageModulationModeNV
{
...
namespace mscorlib
{
	...
	{
		AssemblyBuilderAccess_Run = 0x1,
		AssemblyBuilderAccess_Save = 0x2,
		AssemblyBuilderAccess_RunAndSave = 0x3,
		AssemblyBuilderAccess_ReflectionOnly = 0x6,
		AssemblyBuilderAccess_RunAndCollect = 0x9,
	};
}
...
namespace mscorlib
{
	...
	{
		PrincipalPolicy_UnauthenticatedPrincipal = 0x0,
		PrincipalPolicy_NoPrincipal = 0x1,
		PrincipalPolicy_WindowsPrincipal = 0x2,
	};
}
...
namespace mscorlib
{
	...
	{
		EventAttributes_None = 0x0,
		EventAttributes_SpecialName = 0x200,
		EventAttributes_ReservedMask = 0x400,
		EventAttributes_RTSpecialName = 0x400,
	};
}
...
namespace mscorlib
{
	...
	{
		FieldAttributes_FieldAccessMask = 0x7,
		FieldAttributes_PrivateScope = 0x0,
		FieldAttributes_Private = 0x1,
		FieldAttributes_FamANDAssem = 0x2,
		FieldAttributes_Assembly = 0x3,
		FieldAttributes_Family = 0x4,
		FieldAttributes_FamORAssem = 0x5,
		FieldAttributes_Public = 0x6,
		FieldAttributes_Static = 0x10,
		FieldAttributes_InitOnly = 0x20,
		FieldAttributes_Literal = 0x40,
		FieldAttributes_NotSerialized = 0x80,
		FieldAttributes_SpecialName = 0x200,
		FieldAttributes_PinvokeImpl = 0x2000,
		FieldAttributes_ReservedMask = 0x9500,
		FieldAttributes_RTSpecialName = 0x400,
		FieldAttributes_HasFieldMarshal = 0x1000,
		FieldAttributes_HasDefault = 0x8000,
		FieldAttributes_HasFieldRVA = 0x100,
	};
}
...
enum class VkSamplerAddressMode
{
...
enum class VkExternalMemoryFeatureFlagBits
{
...
enum class VkSamplerYcbcrRange
{
...
enum class VkImageCreateFlagBits
{
...
namespace EVulkanBindingType
{
	enum EType
	{
		PackedUniformBuffer = 0x0,
		UniformBuffer = 0x1,
		CombinedImageSampler = 0x2,
		Sampler = 0x3,
		Image = 0x4,
		UniformTexelBuffer = 0x5,
		StorageImage = 0x6,
		StorageTexelBuffer = 0x7,
		StorageBuffer = 0x8,
		InputAttachment = 0x9,
		Count = 0xa,
	};
...
enum class VkFenceCreateFlagBits
{
...
enum class VkFenceImportFlagBits
{
...
enum class VkDescriptorUpdateTemplateType
{
...
enum class VkIndirectCommandsTokenTypeNVX
{
...
enum class VkShaderInfoTypeAMD
{
...
enum class VkDependencyFlagBits
{
...
enum class VkImageUsageFlagBits
{
...
enum class VkQueueGlobalPriorityEXT
{
...
enum class VkSurfaceTransformFlagBitsKHR
{
...
enum class VkInternalAllocationType
{
...
enum class VkSamplerMipmapMode
{
...
enum class VkExternalSemaphoreHandleTypeFlagBits
{
...
enum class VkCommandPoolCreateFlagBits
{
...
enum class VkExternalFenceHandleTypeFlagBits
{
...
enum class VkMemoryHeapFlagBits
{
...
enum class VkStructureType
{
	...
	VK_STRUCTURE_TYPE_MIR_SURFACE_CREATE_INFO_KHR = 0x3b9ae558,
...
namespace VulkanRHI
{
	enum EStateKey
	{
		NUMBITS_BLEND_STATE = 0x6,
		NUMBITS_RENDER_TARGET_FORMAT = 0x4,
		NUMBITS_LOAD_OP = 0x2,
		NUMBITS_STORE_OP = 0x2,
		NUMBITS_CULL_MODE = 0x2,
		NUMBITS_POLYFILL = 0x1,
		NUMBITS_POLYTYPE = 0x3,
		NUMBITS_DEPTH_COMPARE_OP = 0x3,
		NUMBITS_STENCIL_STATE = 0x5,
		NUMBITS_NUM_COLOR_BLENDS = 0x3,
		NUMBITS_NUM_SAMPLES_MINUS_ONE = 0x4,
		OFFSET_BLEND_STATE = 0x0,
	};
}
...
enum class VkSemaphoreImportFlagBits
{
...
enum class VkObjectEntryTypeNVX
{
...
enum class VkPipelineCacheHeaderVersion
{
	VK_PIPELINE_CACHE_HEADER_VERSION_ONE = 0x1,
};

enum class VkSampleCountFlagBits
{
...
enum class VkMemoryPropertyFlagBits
{
...
enum class VkPipelineStageFlagBits
{
...
enum class VkBufferUsageFlagBits
{
...
enum class VkPipelineCreateFlagBits
{
...
enum class VkDisplayEventTypeEXT
{
	VK_DISPLAY_EVENT_TYPE_FIRST_PIXEL_OUT_EXT = 0x0,
};

enum class VkShaderStageFlagBits
{
...
enum class VkColorComponentFlagBits
{
...
namespace FVulkanTimestampPool
{
	enum EState
	{
		Undefined = 0x0,
...
enum class VkCommandBufferResetFlagBits
{
	VK_COMMAND_BUFFER_RESET_RELEASE_RESOURCES_BIT = 0x1,
	VK_COMMAND_BUFFER_RESET_FLAG_BITS_MAX_ENUM = 0x7fffffff,
};

enum class VkImageType
{
...
namespace VulkanRHI
{
	enum EImageLayoutBarrier
	{
		Undefined = 0x0,
		TransferDest = 0x1,
		ColorAttachment = 0x2,
		DepthStencilAttachment = 0x3,
		TransferSource = 0x4,
		Present = 0x5,
		PixelShaderRead = 0x6,
		PixelDepthStencilRead = 0x7,
		ComputeGeneralRW = 0x8,
		PixelGeneralRW = 0x9,
		DepthReadStencilAttachment = 0xa,
	};
}

enum class VkCompositeAlphaFlagBitsKHR
{
...
enum class VkMemoryAllocateFlagBits
{
...
enum class VkPrimitiveTopology
{
...
enum class VkValidationCacheHeaderVersionEXT
{
	VK_VALIDATION_CACHE_HEADER_VERSION_ONE_EXT = 0x1,
};

enum class VkValidationCheckEXT
{
...
enum class RpcProxyPerfCounters
{
...
enum class EPrintXPSJobProgress
{
	kAddingDocumentSequence = 0x0,
	kDocumentSequenceAdded = 0x1,
	kAddingFixedDocument = 0x2,
	kFixedDocumentAdded = 0x3,
	kAddingFixedPage = 0x4,
	kFixedPageAdded = 0x5,
	kResourceAdded = 0x6,
	kFontAdded = 0x7,
	kImageAdded = 0x8,
	kXpsDocumentCommitted = 0x9,
};

enum class EPrintXPSJobOperation
{
	kJobProduction = 0x1,
	kJobConsumption = 0x2,
};
